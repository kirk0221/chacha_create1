	    ...
	    <nav class="sidebar">
	        <ul>
	            <li class="has-submenu">
	                ...
	                <ul class="submenu">
	                    <li><a href="mainauth/pages/storeSettlementContent.jsp" class="menu-link">스토어 정산 관리</a></li>
	            ...
	            <li class="has-submenu">
	                ...
	                <ul class="submenu">
	                    <li><a href="mainauth/pages/suggestionContent.jsp" class="menu-link">건의사항</a></li>
	                    <li><a href="#" class="menu-link">신고</a></li>
	                </ul>
	            </li>
	            <li><a href="pages/memberManageContent.jsp" class="menu-link">스토어 관리</a></li>
	            <li><a href="pages/memberManageContent.jsp" class="menu-link">회원 관리</a></li>
	        </ul>
	    </nav>
