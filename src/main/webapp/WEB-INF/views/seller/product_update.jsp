			 ...
			 <div class="form-body-row">
	          <div class="frame-1076">
				  ...
				  <button class="frame-817-btn" type="button" aria-label="추가 버튼">
				    <img src="resources/images/1.jpg" alt="1번 이미지" style="width: 100%; height: 100%; object-fit: cover;" />
				  </button>
	             <div class="frame-1077">
				    <button class="frame-8152-btn">
				      <img src="resources/images/2.jpg" alt="2번 이미지" style="width: 100%; height: 100%; object-fit: cover;" />
				    </button>
				    <button class="frame-8152-btn">
				      <img src="resources/images/3.jpg" alt="3번 이미지" style="width: 100%; height: 100%; object-fit: cover;" />
				    </button>
				  </div>
