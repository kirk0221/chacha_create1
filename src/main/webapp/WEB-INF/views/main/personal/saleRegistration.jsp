        ...
        <div class="swiper-slide">
          <div class="slide-full">
            <div class="slide-card">
			  ...
			  <div class="form-group">
			    <label>카테고리</label>
			    <select id="typeCategory" class="category-select"><option>대분류 선택</option></select>
			    <select id="uCategory" class="category-select"><option>중분류 선택</option></select>
			    <select id="dCategory" class="category-select"><option>소분류 선택</option></select>
			  </div>
			</div>
          ...
          <div class="slide-full">
            <div class="slide-card">
              ...
              <div class="product-info">
                ...
                <input type="number" id="price1" placeholder="가격">
                <p>재고 <strong>NN</strong> 개</p>
                <input type="number" id="stock1" placeholder="재고">

                <div class="category">
                  <label>대분류</label>
                  <select id="typeCategory1" class="category-select">...</select>

                  <label>중분류</label>
                  <select id="uCategory1" class="category-select">...</select>

                  <label>소분류</label>
                  <select id="dCategory1" class="category-select">...</select>
                </div>
              </div>
            </div>
