...
INSERT INTO seller (seller_id, member_id, opening_date, account, account_bank, profile_info) VALUES
(seq_seller_id.nextval, 4, TO_DATE('2024-04-01','YYYY-MM-DD'), '456-789-0123', '우리은행', '프로필4');
INSERT INTO seller (seller_id, member_id, opening_date, account, account_bank, profile_info) VALUES
(seq_seller_id.nextval, 5, TO_DATE('2024-05-01','YYYY-MM-DD'), '567-890-1234', '농협은행', '프로필5');
...
INSERT INTO store (store_id, seller_id, logo_img, store_name, store_detail, store_url, sale_cnt, view_cnt) VALUES
(seq_store_id.nextval, 4, 'logo4.jpg', '스토어4', '설명4', 'store4', 40, 400);
INSERT INTO store (store_id, seller_id, logo_img, store_name, store_detail, store_url, sale_cnt, view_cnt) VALUES
(seq_store_id.nextval, 5, 'logo5.jpg', '스토어5', '설명5', 'store5', 50, 500);
